...
var demo = new Vue({
  ...
  data: {
    searchQuery: '',
    gridColumns: ['photo','name', 'species', 'dob', 'shots', 'sex', 'neutered', 'alive', 'notes', 'link_to_owner'],
    gridData: [],
    table: '',
    col: '',
    //numRows: 1,
